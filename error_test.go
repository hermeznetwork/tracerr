...
func TestError(t *testing.T) {
	cases := []ErrorTestCase{
		...
		},
		{
			...
			ExpectedStackTrace: []tracerr.Frame{
				{
					Func: "github.com/hermeznetwork/tracerr_test.TestError",
					Line: 31,
					Path: "/src/github.com/hermeznetwork/tracerr/error_test.go",
				},
			},
		},
		{
		...
		},
		{
			...
			ExpectedStackTrace: []tracerr.Frame{
				{
					Func: "github.com/hermeznetwork/tracerr_test.addFrameC",
					Line: 17,
					Path: "/src/github.com/hermeznetwork/tracerr/error_helper_test.go",
				},
				{
					Func: "github.com/hermeznetwork/tracerr_test.addFrameB",
					Line: 13,
					Path: "/src/github.com/hermeznetwork/tracerr/error_helper_test.go",
				},
				{
					Func: "github.com/hermeznetwork/tracerr_test.addFrameA",
					Line: 9,
					Path: "/src/github.com/hermeznetwork/tracerr/error_helper_test.go",
				},
				{
